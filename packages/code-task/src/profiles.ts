...
const PROFILES: Record<ExecutionProfile["id"], ExecutionProfile> = {
  "web-e2e-author": {
    ...
    allowedEnvironmentKeys: ["CODEX_API_KEY", "OPENAI_API_KEY", "PLAYWRIGHT_BROWSERS_PATH", "QASEY_E2E_BASE_URL", "QASEY_E2E_STORAGE_STATE_PATH"],
  ...
  "code-review-readonly": {
    ...
    allowedCheckIds: [], allowedEnvironmentKeys: ["CODEX_API_KEY", "OPENAI_API_KEY"], initialAgentMode: "read-only",
  },
};
